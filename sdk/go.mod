module github.com/welleren/go-admin-core/sdk
...
require (
	...
	github.com/welleren/go-admin-core v1.0.0
	github.com/welleren/go-admin-core/plugins/logger/zap v1.0.0
...
//replace github.com/welleren/go-admin-core => ../
